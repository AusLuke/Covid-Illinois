...
<body>
	<h3 align="center"> Highest Infection and Death Rate by County as Percentage of Total County Population of Each US State </h3>
...
<c:forEach items="${CQ3List}" var="user">
	<tr>
